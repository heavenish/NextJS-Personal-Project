  ...
  return (
    <Layout>
      <div className={styles.about}>
        <h1>About Me</h1>
        <p>
          Hey there, I&rsquo;m a software developer who&rsquo;s passionate about
          creating innovative solutions with attention to detail. I love
          exploring and learning new technologies and figuring out how to apply
