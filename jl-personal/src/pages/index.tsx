    ...
    <Layout>
      ...
      <div className={styles.welcomeSection}>
        ...
        <p className={styles.introText}>
          &ldquo;Hi there! I`m Jungro, a passionate software engineer with a
          deep interest in full-stack development, artificial intelligence, and
          ...
          explore my website and learn more about my projects and experiences.
          -ChatGPT&rdquo;
          <br />
